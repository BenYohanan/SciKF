...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    super.initState();
    _newsFuture = _apiService.fetchScienceNews();
  }
      ...
      body: FutureBuilder<List<NewsItem>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return Center(child: Text('Error: ${snapshot.error}', style: TextStyle(color: Colors.red[400])));
          } else if (!snapshot.hasData || snapshot.data!.isEmpty) {
            return Center(child: Text('No news available', style: TextStyle(fontSize: getProportionateScreenWidth(16))));
          }
